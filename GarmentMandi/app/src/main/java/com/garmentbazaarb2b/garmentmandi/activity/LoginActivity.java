...
public class LoginActivity extends AppCompatActivity implements OnTaskCompleted {
    ...
    private static String url_create_product = "http://garmentbazaarb2b.com/api/v1.0/users/login.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bLoginTop = (Button) findViewById(R.id.bLoginTop);
                        ...
                        public void onTaskCompleted() {
                            ...
                            if (sErrorMsg.length() > 0)
                            {
                               // errorMsg.setText(sErrorMsg);
                                Toast.makeText(LoginActivity.this, sErrorMsg, Toast.LENGTH_LONG).show();
                            }
                            else
                            {
                                errorMsg.setText("");
        ...
        bLoginTop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(validateInput())
                {
                    ...
                    Login asyncTask =new Login(new OnTaskCompleted() {
                        ...
                        public void onTaskCompleted() {
                            ...
                            {
                                errorMsg.setText("");
                                //TODO: Lokendra: Add Call to Home Screen Below..
                              //  Intent i = new Intent(LoginActivity.this, WelcomeActivity.class);
                              //  startActivity(i);
