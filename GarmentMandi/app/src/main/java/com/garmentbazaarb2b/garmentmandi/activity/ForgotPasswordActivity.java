...
public class ForgotPasswordActivity extends AppCompatActivity implements OnTaskCompleted {
    ...
    private static String url_create_product = "http://garmentbazaarb2b.com/api/v1.0/users/forgot_password.json";
                        ...
                        public void onTaskCompleted() {
                            ...
                            if (sErrorMsg.length() > 0)
                            {
                               // errorMsg.setText(sErrorMsg);
                                Toast.makeText(ForgotPasswordActivity.this,sErrorMsg , Toast.LENGTH_LONG).show();
                            }
                            else
                            {
                                Toast.makeText(ForgotPasswordActivity.this,"Password has been emailed to you." , Toast.LENGTH_LONG).show();
